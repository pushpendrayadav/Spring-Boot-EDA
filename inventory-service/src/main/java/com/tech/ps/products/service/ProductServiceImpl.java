...
import com.tech.ps.core.ProductQuantityNotAvailableException;
import com.tech.ps.core.dto.Product;
import com.tech.ps.products.dao.jpa.entity.ProductEntity;
import com.tech.ps.products.dao.jpa.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product reserve(Product desiredProduct, UUID orderId) {
        ...
        if (desiredProduct.getQuantity() > productEntity.getQuantity()) {
            throw new ProductQuantityNotAvailableException(productEntity.getId(), orderId);
        }
